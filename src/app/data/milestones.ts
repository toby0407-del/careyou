...
const EXTRA_LOCKED_MILESTONES: Milestone[] = [
  ...
  ["level-4", "level", "四關突破", "完成 4 個復健關卡", Trophy, 4, 3, "關", "text-teal-300", "bg-teal-50", "解鎖新挑戰島"],
  ["level-5", "level", "五星衝刺", "完成 5 個復健關卡", Trophy, 5, 3, "關", "text-emerald-400", "bg-emerald-50", "獲得進階星星包"],
  ["level-speed", "level", "快速通關", "7 天內完成 2 個關卡", Zap, 2, 1, "關", "text-teal-300", "bg-teal-50", "速度達人成就"],
